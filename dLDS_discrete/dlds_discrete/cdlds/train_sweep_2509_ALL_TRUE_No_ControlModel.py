...
def main(args):
    ...
    if args.generate_data:
        ...
        generator = DLDSwithControl(CdLDSDataGenerator(
            K=num_true_subdyn, D_control=ctrl_size, fix_point_change=fix_point_change, eigenvalue_radius=float(eigenvalue_radius), set_seed=num_true_subdyn))
    ...
    if args.wandb:
        run = wandb.init(
            ...
            project=f"PROTOTYPE_{str(args.num_subdyn)}_State_ALL_TRUE_No_ControlModel",
